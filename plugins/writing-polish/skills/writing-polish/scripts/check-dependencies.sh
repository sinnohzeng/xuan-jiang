#!/usr/bin/env bash
# check-dependencies.sh —— writing-polish v10.1 依赖检查 + 单向依赖自检
#
...
if [[ "${1:-}" == "--check-cycles" ]]; then
    ...
    echo "▼ 单向依赖自检 v10.1（依赖方向 SKILL.md → { references/, scripts/, assets/ }；agents/ 由主对话经 Task 调用）"
    echo
...
echo "================================================"
echo "  writing-polish v10.1 依赖检查"
echo "================================================"
echo
