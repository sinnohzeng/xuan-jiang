...
| 第七讲 领导讲话稿 | 三个吃透 + 五维度（实/深/高/新鲜/气势）；受众三问（L961“一要明白谁要讲话，二要明白在什么场合对什么人讲话，三要明白印发下去的讲话给谁看”）；时长基准（L1149：即席 15 分钟 / 一般会议 25 分钟 / 年度主报告 1.5-2 小时）；避生僻词（L1151）；宜短不宜长 | Polish 体裁 G2 切片；受众三问 → 站位四问的问题三（媒介与文体）、问题四（第二受众）；时长基准与避生僻词 → genre-guide §二 | [`genre-guide.md`](genre-guide.md) §二 + [`stance-and-register.md`](stance-and-register.md) §1 + [`constitution.md`](constitution.md) §2.2 | calibration G2 段 |
...
| 第十二讲 修改文稿文章经验谈 | 热写冷改（L1707）、先大后小（L1709）、先减后加（L1715）、念改（L1785）；机关文稿修改三把闸：政治关/思想关/业务关（L1725“政治上不能有任何偏差，懂政治和讲政治是第一位的”）；一文一主题 | Polish step 3 修改哲学 + reviewer“他批”礼貌；冷读/念改；政治关 → 站位第一顺位与 [`stance-and-register.md`](stance-and-register.md) §2.1 听众反应预演（政治敏感体裁逐句核对站位不出偏差） | [`peer-vs-self-revision.md`](peer-vs-self-revision.md) + [`revision-checklist.md`](revision-checklist.md) + SKILL.md §6 修改哲学 + [`scenarios/party-lecture.md`](scenarios/party-lecture.md) | —（流程类） |
...
- **听众反应预演与稿件血统溯源**（v10.0）：非原书内容，蒸馏自 2026-07 党课实战（详 [`scenarios/party-lecture.md`](scenarios/party-lecture.md)）；方法论上接第七讲受众意识（L961-963）与第十二讲政治关（L1725）。
- **站位四问的问题三、四**（媒介与文体 / 第二受众，v10.0）：原书第七讲受众三问的工程化展开（L961）。
