...
轩匠是一个专注中文写作的 Claude Code 插件。它把任仲然 40 年公文写作方法论（《怎样写作》）转化为 AI 可执行的写作与润色工作流，配套一套约 80 条规则的中文 AI 味检查机制，并用 clean-context 审稿子代理做反馈式审校。
...
轩匠分别用“立意/结构/材料正向审查”“先大后小的改稿哲学”“约 80 条 AI 味红线与 clean-context 复核”对应这三种。
